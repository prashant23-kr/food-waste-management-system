    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center py-12">
        ...
        <p className="text-secondary-500 mb-8">
          Track the difference your donations are making in the community.
        </p>
        <div className="grid md:grid-cols-3 gap-6">
          <div className="card p-6 text-center">
            <p className="text-4xl font-bold text-primary-600 mb-2">0</p>
            <p className="text-secondary-500">Meals Saved</p>
          </div>
          <div className="card p-6 text-center">
          ...
          <div className="card p-6 text-center">
            ...
            <p className="text-secondary-500">People Helped</p>
          </div>
        </div>
      </div>
    </div>
