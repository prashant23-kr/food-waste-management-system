...
const NGOLayout = () => {
  ...
  const navItems = [
    { path: "/ngo/dashboard", label: "Overview", icon: LayoutDashboard },
    { path: "/ngo/donations", label: "Available Donations", icon: Package },
    { path: "/ngo/my-donations", label: "My Donations", icon: Users },
    { path: "/ngo/impact", label: "Impact", icon: BarChart3 },
    { path: "/ngo/profile", label: "Profile", icon: User },
  ];

  const bottomItems = [
    { path: "/ngo/settings", label: "Settings", icon: Settings },
  ];
